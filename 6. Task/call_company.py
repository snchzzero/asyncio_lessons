data = [
    ...
    {'Name': 'Company11', 'Address': '4709 Brooks Camp Suite 799, Port Natalie, NY 99637', 'Phone': '(818)703-8797',
     ...
     'call_time': 1}, 
    {'Name': 'Company12', 'Address': '0372 Jared Isle Suite 075, South Anthony, GU 21805', 'Phone': '451.393.2570x70097', 
     'Email': 'kendramurray@olson.biz', 'Website': 'https://clark.net/', 'Year': 2010, 'Employees': 7653,
     'Description': 'Open-architected exuding functionalities', 'CEO': 'Anita Peterson','TaxID': 5838627215, 
     'call_time': 4},
